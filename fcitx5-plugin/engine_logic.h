...
public:
    ...
    bool processKey(const KeyInput &input, EngineState *state,
                    IEngineOutput *out);
...
private:
    ...
    void commitTopCandidate(EngineState *state, IEngineOutput *out,
    ...
    mergeCustomPhrases(const std::string &code,
